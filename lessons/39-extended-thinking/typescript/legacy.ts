 ...
 * Opus 5, Opus 4.7/4.8 and the Fable family. It is deprecated-but-working on
 * Opus 4.6 and Sonnet 4.6, and still REQUIRED on Haiku 4.5 and older.
 *
...
console.log(
  `Sending thinking: {type: "enabled", budget_tokens: 5000} to ${MODEL}...\n`,
);
...
try {
  ...
  console.log(`Accepted. stop_reason=${message.stop_reason}`);
  console.log(
  ...
  if (error instanceof Anthropic.BadRequestError) {
    ...
    console.log(
      "\nThis is the current behaviour. The replacement is adaptive thinking\n" +
        "plus output_config.effort - see example.ts.\n\n" +
